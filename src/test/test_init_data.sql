...
--
-- Host_ 127.0.0.1    Database: payments
-- ------------------------------------------------------
...
CREATE TABLE `actor` (`id` int(10) unsigned NOT NULL AUTO_INCREMENT,  `act_name` varchar(45) NOT NULL DEFAULT '',  `pass` varchar(45) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bill` (`id` int(10) unsigned NOT NULL AUTO_INCREMENT,  `isBlocked` bit(1) NOT NULL,  `score` double NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `card` (`id` int(10) unsigned NOT NULL AUTO_INCREMENT,  `card_name` varchar(45) NOT NULL DEFAULT '',  `id_actor` int(10) unsigned NOT NULL,  `id_bill` int(10) unsigned NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `id_bill_UNIQUE` (`id_bill`),  KEY `Card-Client` (`id_actor`),  KEY `Card-Bill` (`id_bill`)) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-14 19_21_36